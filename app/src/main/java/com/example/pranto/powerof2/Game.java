...
public class Game extends AppCompatActivity{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId()==R.id.mainmenuId) {
            ...
            alertDialogBuilder.setTitle("MAIN MENU");
            alertDialogBuilder.setMessage("DO YOU WANT TO GO MAIN MENU?");
            alertDialogBuilder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    finish();
                    Toast.makeText(Game.this, "MAIN MENU", Toast.LENGTH_SHORT).show();
                }
            });
            alertDialogBuilder.setNegativeButton("NO", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    Toast.makeText(Game.this, "CONTINUE", Toast.LENGTH_SHORT).show();
                }
            });
        ...
        if(item.getItemId()==R.id.quitId) {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this);
            alertDialogBuilder.setTitle("QUIT GAME");
            alertDialogBuilder.setMessage("DO YOU WANT TO QUIT GAME?");
            alertDialogBuilder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    finish();
                    ...
                    System.exit(1);
                    Toast.makeText(Game.this, "QUIT GAME SUCCESSFULLY", Toast.LENGTH_SHORT).show();
                }
            });
            alertDialogBuilder.setNegativeButton("NO", new DialogInterface.OnClickListener() {
                @Override
        ...
        if(item.getItemId()==R.id.aboutthegameId) {
            Intent i=new Intent(this, RulesOfGameActivity.class);
            startActivity(i);
            Toast.makeText(Game.this, "RULES OF THE GAME", Toast.LENGTH_SHORT).show();
            return true;
        }
    ...
    public void gridChanged(List plantsList)
    {
        ...
        grid.setAdapter(new ArrayAdapter<String>(
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                tv.setBackgroundColor(Color.parseColor("#a8b9bd"));
